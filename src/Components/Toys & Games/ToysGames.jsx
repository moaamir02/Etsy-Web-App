...
import ToysGamesCard from './ToysGamesCard';
import { ToysGamesData } from '../../Constant';
...
const ToysGames = () => {
    ...
    const firstRowImages = ToysGamesData.slice(0, imagesPerPage);
    // Slicing the data to get the images for the second row if showMore is true
    const secondRowImages = showMore ? ToysGamesData.slice(imagesPerPage, imagesPerPage * 2) : [];
    // Slicing the data to get the remaining images if showMore is true
    const remainingImages = showMore ? ToysGamesData.slice(imagesPerPage * 2) : [];
    ...
    return (
      <div>
        ...
        <div className="heading-para mt-8">
          <h1 className="heading text-center text-4xl font-thin text-gray-800">Toys & Games</h1> {/* Updated the heading */}
          <p className="text-center mt-2 text-gray-700">
          Stuffed animals, costumes and games for all ages {/* This description might also need updating */}
          </p>
        </div>
